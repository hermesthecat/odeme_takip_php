            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="/income"><i class="bi bi-wallet2"></i> Gelirler</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/expense"><i class="bi bi-cash-stack"></i> Giderler</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/savings"><i class="bi bi-piggy-bank"></i> Birikimler</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/budget"><i class="bi bi-graph-up"></i> Bütçe</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/reminders"><i class="bi bi-bell"></i> Hatırlatıcılar</a>
                        </li>
                    </ul>
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link" href="/profile"><i class="bi bi-person-circle"></i> Profil</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/settings"><i class="bi bi-gear"></i> Ayarlar</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/api/auth?action=logout"><i class="bi bi-box-arrow-right"></i> Çıkış</a>
                        </li>
                    </ul>
                </div>
            </div>
